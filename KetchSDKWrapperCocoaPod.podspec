...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of KetchSDKWrapperCocoaPod.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Justin Boileau/KetchSDKWrapperCocoaPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Justin Boileau' => 'justin.boileau@ketch.com' }
  s.source           = { :git => 'https://github.com/Justin Boileau/KetchSDKWrapperCocoaPod.git', :tag => s.version.to_s }
